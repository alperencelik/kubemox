...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		"github.com/alperencelik/kubemox/api/ops/v1alpha1.Node":                  schema_kubemox_api_ops_v1alpha1_Node(ref),
		"github.com/alperencelik/kubemox/api/ops/v1alpha1.NodeList":              schema_kubemox_api_ops_v1alpha1_NodeList(ref),
		"github.com/alperencelik/kubemox/api/ops/v1alpha1.PowerAction":           schema_kubemox_api_ops_v1alpha1_PowerAction(ref),
		"github.com/alperencelik/kubemox/api/ops/v1alpha1.Task":                  schema_kubemox_api_ops_v1alpha1_Task(ref),
		"github.com/alperencelik/kubemox/api/ops/v1alpha1.TaskList":              schema_kubemox_api_ops_v1alpha1_TaskList(ref),
		"github.com/alperencelik/kubemox/api/ops/v1alpha1.TaskRef":               schema_kubemox_api_ops_v1alpha1_TaskRef(ref),
		"github.com/alperencelik/kubemox/api/ops/v1alpha1.VirtualMachine":        schema_kubemox_api_ops_v1alpha1_VirtualMachine(ref),
		"github.com/alperencelik/kubemox/api/ops/v1alpha1.VirtualMachineList":    schema_kubemox_api_ops_v1alpha1_VirtualMachineList(ref),
		"github.com/alperencelik/kubemox/api/ops/v1alpha1.VirtualMachineMetrics": schema_kubemox_api_ops_v1alpha1_VirtualMachineMetrics(ref),
		"github.com/alperencelik/kubemox/api/ops/v1alpha1.VirtualMachineSpec":    schema_kubemox_api_ops_v1alpha1_VirtualMachineSpec(ref),
		"github.com/alperencelik/kubemox/api/ops/v1alpha1.VirtualMachineStatus":  schema_kubemox_api_ops_v1alpha1_VirtualMachineStatus(ref),
...
func schema_kubemox_api_ops_v1alpha1_Node(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "Node is a live projection of a Proxmox cluster node.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"connectionName": {
						SchemaProps: spec.SchemaProps{
							Description: "ConnectionName is the ProxmoxConnection CR this node was discovered through.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Description: "Status: \"online\" or \"offline\".",
							Default:     "",
							Type:        []string{"string"},
							Format:      "",
						},
					...
					"cpuUsage": {
						SchemaProps: spec.SchemaProps{
							Description: "CPUUsage is a fraction in [0,1].",
							Default:     0,
							Type:        []string{"number"},
							Format:      "double",
						},
					...
					"cpuCount": {
						SchemaProps: spec.SchemaProps{
							Description: "CPUCount allocated on this node.",
							Default:     0,
							Type:        []string{"integer"},
							Format:      "int32",
						},
					...
					"memoryUsedBytes": {
						SchemaProps: spec.SchemaProps{
							Description: "MemoryUsedBytes / MemoryTotalBytes.",
							Default:     0,
							Type:        []string{"integer"},
							Format:      "int64",
						},
					...
					"uptimeSeconds": {
						SchemaProps: spec.SchemaProps{
							Description: "UptimeSeconds since last boot.",
							Default:     0,
							Type:        []string{"integer"},
							Format:      "int64",
						},
					...
					"version": {
						SchemaProps: spec.SchemaProps{
							Description: "Version of pve-manager running.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
				},
				Required: []string{"status", "cpuUsage", "cpuCount", "memoryUsedBytes", "memoryTotalBytes", "uptimeSeconds"},
			},
		},
		Dependencies: []string{
...
func schema_kubemox_api_ops_v1alpha1_NodeList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "NodeList is a list of Nodes across all known ProxmoxConnections.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/alperencelik/kubemox/api/ops/v1alpha1.Node"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/alperencelik/kubemox/api/ops/v1alpha1.Node", v1.ListMeta{}.OpenAPIModelName()},
	}
}

func schema_kubemox_api_ops_v1alpha1_PowerAction(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "PowerAction is the request/response body for power-lifecycle verbs (/start, /stop, /reboot, /shutdown). On request, fields are optional (callers may POST an empty body). On response, TaskRef points at the Proxmox task; clients poll /apis/ops.proxmox.alperen.cloud/v1alpha1/tasks/{upid}.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
					...
					"forceStop": {
						SchemaProps: spec.SchemaProps{
							Description: "ForceStop, when true on /stop, kills the VM instead of an ACPI shutdown.",
							Type:        []string{"boolean"},
							Format:      "",
						},
					},
					"timeoutSeconds": {
						SchemaProps: spec.SchemaProps{
							Description: "TimeoutSeconds bounds how long Proxmox waits for ACPI shutdown.",
							Type:        []string{"integer"},
							Format:      "int32",
						},
					},
					"taskRef": {
						SchemaProps: spec.SchemaProps{
							Description: "TaskRef is set on the response only.",
							Ref:         ref("github.com/alperencelik/kubemox/api/ops/v1alpha1.TaskRef"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"github.com/alperencelik/kubemox/api/ops/v1alpha1.TaskRef", v1.ObjectMeta{}.OpenAPIModelName()},
	}
}

func schema_kubemox_api_ops_v1alpha1_Task(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "Task is a live projection of a Proxmox task. Returned by GET on the /tasks resource.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
					...
					"node": {
						SchemaProps: spec.SchemaProps{
							Description: "Node the task is running on.",
							Default:     "",
							Type:        []string{"string"},
							Format:      "",
						},
					...
					"type": {
						SchemaProps: spec.SchemaProps{
							Description: "Type is the Proxmox task type (e.g. \"qmstart\", \"qmstop\").",
							Default:     "",
							Type:        []string{"string"},
							Format:      "",
						},
					...
					"user": {
						SchemaProps: spec.SchemaProps{
							Description: "User that initiated the task in Proxmox.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Description: "Status: \"running\", \"stopped\".",
							Default:     "",
							Type:        []string{"string"},
							Format:      "",
						},
					...
					"exitStatus": {
						SchemaProps: spec.SchemaProps{
							Description: "ExitStatus: present when finished — \"OK\" or an error string.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					"startTime": {
						SchemaProps: spec.SchemaProps{
							Description: "StartTime when Proxmox started the task.",
							Ref:         ref(v1.Time{}.OpenAPIModelName()),
						},
					},
					"endTime": {
						SchemaProps: spec.SchemaProps{
							Description: "EndTime when the task finished, if it has.",
							Ref:         ref(v1.Time{}.OpenAPIModelName()),
						},
					},
				},
				Required: []string{"node", "type", "status"},
			},
		},
		Dependencies: []string{
			v1.ObjectMeta{}.OpenAPIModelName(), v1.Time{}.OpenAPIModelName()},
	}
}

func schema_kubemox_api_ops_v1alpha1_TaskList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "TaskList is a list of Tasks across all nodes.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/alperencelik/kubemox/api/ops/v1alpha1.Task"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/alperencelik/kubemox/api/ops/v1alpha1.Task", v1.ListMeta{}.OpenAPIModelName()},
	}
}

func schema_kubemox_api_ops_v1alpha1_TaskRef(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "TaskRef is the minimal identity needed to poll a Proxmox task.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"upid": {
						SchemaProps: spec.SchemaProps{
							Description: "UPID is the Proxmox unique task identifier (the full UPID string).",
							Default:     "",
							Type:        []string{"string"},
							Format:      "",
						},
					...
					"node": {
						SchemaProps: spec.SchemaProps{
							Description: "Node is where the task is running.",
							Default:     "",
							Type:        []string{"string"},
							Format:      "",
						},
				...
				Required: []string{"upid", "node"},
			},
		},
	}
}

func schema_kubemox_api_ops_v1alpha1_VirtualMachine(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "VirtualMachine is a live projection of a Proxmox VM, scoped by the kubemox VirtualMachine CR of the same name. The Spec mirrors the desired kubemox state (read-only here); LiveStatus reflects what Proxmox reports right now.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("github.com/alperencelik/kubemox/api/ops/v1alpha1.VirtualMachineSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("github.com/alperencelik/kubemox/api/ops/v1alpha1.VirtualMachineStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"github.com/alperencelik/kubemox/api/ops/v1alpha1.VirtualMachineSpec", "github.com/alperencelik/kubemox/api/ops/v1alpha1.VirtualMachineStatus", v1.ObjectMeta{}.OpenAPIModelName()},
	}
}

func schema_kubemox_api_ops_v1alpha1_VirtualMachineList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "VirtualMachineList is a list of VM projections.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/alperencelik/kubemox/api/ops/v1alpha1.VirtualMachine"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/alperencelik/kubemox/api/ops/v1alpha1.VirtualMachine", v1.ListMeta{}.OpenAPIModelName()},
	}
}

func schema_kubemox_api_ops_v1alpha1_VirtualMachineMetrics(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "VirtualMachineMetrics is the response of the /metrics subresource. Values are point-in-time samples from Proxmox RRD; rates and historical series are not provided here — point Prometheus at the pve_exporter for those.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
					...
					"timestamp": {
						SchemaProps: spec.SchemaProps{
							Description: "Timestamp is when the sample was taken.",
							Ref:         ref(v1.Time{}.OpenAPIModelName()),
						},
					},
					"cpuUsage": {
						SchemaProps: spec.SchemaProps{
							Description: "CPUUsage is a fraction in [0,1] across all vCPUs.",
							Default:     0,
							Type:        []string{"number"},
							Format:      "double",
						},
					...
					"cpuCount": {
						SchemaProps: spec.SchemaProps{
							Description: "CPUCount is the number of vCPUs allocated.",
							Default:     0,
							Type:        []string{"integer"},
							Format:      "int32",
						},
					...
					"memoryUsedBytes": {
						SchemaProps: spec.SchemaProps{
							Description: "MemoryUsedBytes currently allocated.",
							Default:     0,
							Type:        []string{"integer"},
							Format:      "int64",
						},
					...
					"memoryTotalBytes": {
						SchemaProps: spec.SchemaProps{
							Description: "MemoryTotalBytes available to the guest.",
							Default:     0,
							Type:        []string{"integer"},
							Format:      "int64",
						},
					...
					"diskReadBytes": {
						SchemaProps: spec.SchemaProps{
							Description: "DiskReadBytes / DiskWriteBytes — cumulative since boot.",
							Default:     0,
							Type:        []string{"integer"},
							Format:      "int64",
						},
					...
					"netInBytes": {
						SchemaProps: spec.SchemaProps{
							Description: "NetInBytes / NetOutBytes — cumulative since boot.",
							Default:     0,
							Type:        []string{"integer"},
							Format:      "int64",
						},
				...
				Required: []string{"timestamp", "cpuUsage", "cpuCount", "memoryUsedBytes", "memoryTotalBytes", "diskReadBytes", "diskWriteBytes", "netInBytes", "netOutBytes", "uptimeSeconds"},
			},
		},
		Dependencies: []string{
			v1.ObjectMeta{}.OpenAPIModelName(), v1.Time{}.OpenAPIModelName()},
...
func schema_kubemox_api_ops_v1alpha1_VirtualMachineSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "VirtualMachineSpec is a read-only snapshot of the kubemox CR spec keys most relevant to ops. The aggregated apiserver does not accept writes here; modify the underlying kubemox VirtualMachine CR instead.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"nodeName": {
						SchemaProps: spec.SchemaProps{
							Description: "NodeName is the Proxmox node hosting this VM.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					"connectionName": {
						SchemaProps: spec.SchemaProps{
							Description: "ConnectionName is the ProxmoxConnection CR backing the VM.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					"vmID": {
						SchemaProps: spec.SchemaProps{
							Description: "VMID is the Proxmox numeric ID (resolved live).",
							Type:        []string{"integer"},
							Format:      "int32",
						},
					},
...
func schema_kubemox_api_ops_v1alpha1_VirtualMachineStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "VirtualMachineStatus is the live Proxmox state.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"state": {
						SchemaProps: spec.SchemaProps{
							Description: "State is \"running\", \"stopped\", or \"unknown\".",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					"uptimeSeconds": {
						SchemaProps: spec.SchemaProps{
							Description: "UptimeSeconds since last boot, 0 if stopped.",
							Type:        []string{"integer"},
							Format:      "int64",
						},
					},
					"ipAddress": {
						SchemaProps: spec.SchemaProps{
							Description: "IPAddress reported by qemu-guest-agent, if available.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					"osInfo": {
						SchemaProps: spec.SchemaProps{
							Description: "OSInfo from qemu-guest-agent or ostype config.",
							Type:        []string{"string"},
							Format:      "",
						},
					},

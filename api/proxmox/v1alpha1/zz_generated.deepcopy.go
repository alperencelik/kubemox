...
func (in *VirtualMachineSpecTemplate) DeepCopyInto(out *VirtualMachineSpecTemplate) {
	*out = *in
	if in.Disk != nil {
		in, out := &in.Disk, &out.Disk
		*out = make([]VirtualMachineSpecTemplateDisk, len(*in))
		copy(*out, *in)
	}
	if in.Network != nil {
		in, out := &in.Network, &out.Network
		*out = new([]VirtualMachineSpecTemplateNetwork)
		if **in != nil {
			in, out := *in, *out
			*out = make([]VirtualMachineSpecTemplateNetwork, len(*in))
			copy(*out, *in)
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VirtualMachineSpecTemplateDisk) DeepCopyInto(out *VirtualMachineSpecTemplateDisk) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VirtualMachineSpecTemplateDisk.
func (in *VirtualMachineSpecTemplateDisk) DeepCopy() *VirtualMachineSpecTemplateDisk {
	if in == nil {
		return nil
	}
	out := new(VirtualMachineSpecTemplateDisk)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VirtualMachineSpecTemplateNetwork) DeepCopyInto(out *VirtualMachineSpecTemplateNetwork) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VirtualMachineSpecTemplateNetwork.
func (in *VirtualMachineSpecTemplateNetwork) DeepCopy() *VirtualMachineSpecTemplateNetwork {
	if in == nil {
		return nil
	}
	out := new(VirtualMachineSpecTemplateNetwork)

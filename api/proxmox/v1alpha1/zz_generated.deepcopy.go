...
func (in *ContainerTemplate) DeepCopyInto(out *ContainerTemplate) {
	*out = *in
	if in.Image != nil {
		...
		*out = new(ContainerTemplateImage)
		**out = **in
	}
	if in.Disk != nil {
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ContainerTemplateImage) DeepCopyInto(out *ContainerTemplateImage) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ContainerTemplateImage.
func (in *ContainerTemplateImage) DeepCopy() *ContainerTemplateImage {
	if in == nil {
		return nil
	}
	out := new(ContainerTemplateImage)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ObservedSecret) DeepCopyInto(out *ObservedSecret) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ObservedSecret.
func (in *ObservedSecret) DeepCopy() *ObservedSecret {
	if in == nil {
		return nil
	}
	out := new(ObservedSecret)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PCIDevicesSpec) DeepCopyInto(out *PCIDevicesSpec) {
	*out = *in
	if in.Devices != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PCIDevicesSpec.
func (in *PCIDevicesSpec) DeepCopy() *PCIDevicesSpec {
	if in == nil {
		return nil
	}
	out := new(PCIDevicesSpec)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ProxmoxConnection) DeepCopyInto(out *ProxmoxConnection) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ObjectMeta.DeepCopyInto(&out.ObjectMeta)
	in.Spec.DeepCopyInto(&out.Spec)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ProxmoxConnection.
func (in *ProxmoxConnection) DeepCopy() *ProxmoxConnection {
	if in == nil {
		return nil
	}
	out := new(ProxmoxConnection)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *ProxmoxConnection) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ProxmoxConnectionList) DeepCopyInto(out *ProxmoxConnectionList) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ListMeta.DeepCopyInto(&out.ListMeta)
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]ProxmoxConnection, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ProxmoxConnectionList.
func (in *ProxmoxConnectionList) DeepCopy() *ProxmoxConnectionList {
	if in == nil {
		return nil
	}
	out := new(ProxmoxConnectionList)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *ProxmoxConnectionList) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ProxmoxConnectionSpec) DeepCopyInto(out *ProxmoxConnectionSpec) {
	*out = *in
	if in.PasswordFrom != nil {
		in, out := &in.PasswordFrom, &out.PasswordFrom
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ProxmoxConnectionSpec.
func (in *ProxmoxConnectionSpec) DeepCopy() *ProxmoxConnectionSpec {
	if in == nil {
		return nil
	}
	out := new(ProxmoxConnectionSpec)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ProxmoxConnectionStatus) DeepCopyInto(out *ProxmoxConnectionStatus) {
	*out = *in
	if in.Conditions != nil {
		in, out := &in.Conditions, &out.Conditions
		*out = make([]metav1.Condition, len(*in))
	...
	if in.ObservedSecrets != nil {
		...
		*out = make([]ObservedSecret, len(*in))
		copy(*out, *in)
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ProxmoxConnectionStatus.
func (in *ProxmoxConnectionStatus) DeepCopy() *ProxmoxConnectionStatus {
	if in == nil {
		return nil
	}
	out := new(ProxmoxConnectionStatus)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *StorageDownloadURLContent) DeepCopyInto(out *StorageDownloadURLContent) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new StorageDownloadURLContent.
func (in *StorageDownloadURLContent) DeepCopy() *StorageDownloadURLContent {
	if in == nil {
		return nil
	}
	out := new(StorageDownloadURLContent)
	in.DeepCopyInto(out)
	return out
}
...
func (in *StorageDownloadURLSpec) DeepCopyInto(out *StorageDownloadURLSpec) {
	*out = *in
	out.StorageDownloadURLContent = in.StorageDownloadURLContent
	if in.ConnectionRef != nil {
		in, out := &in.ConnectionRef, &out.ConnectionRef
		*out = new(v1.LocalObjectReference)
		**out = **in
...
func (in *VirtualMachineTemplateSpec) DeepCopyInto(out *VirtualMachineTemplateSpec) {
	*out = *in
	in.VirtualMachineConfig.DeepCopyInto(&out.VirtualMachineConfig)
